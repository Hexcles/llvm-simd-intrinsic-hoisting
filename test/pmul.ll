...
define i32 @main() #0 {
  ...
  %43 = and <2 x i64> %41, <i64 4294967295, i64 4294967295>
  %44 = mul <2 x i64> %42, %43
  store <2 x i64> %44, <2 x i64>* @c, align 16
  %45 = load <2 x i64>, <2 x i64>* @c, align 16
  %46 = extractelement <2 x i64> %45, i32 1
  %47 = load <2 x i64>, <2 x i64>* @c, align 16
  %48 = extractelement <2 x i64> %47, i32 0
  %49 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i64 %46, i64 %48)
  ret i32 0
}
