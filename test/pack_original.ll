...
define i32 @main() #0 {
  ...
  %64 = call <16 x i8> @llvm.x86.sse2.packuswb.128(<8 x i16> %61, <8 x i16> %63) #3
  %65 = bitcast <16 x i8> %64 to <2 x i64>
  store <2 x i64> %65, <2 x i64>* %result, align 16
  %66 = load <2 x i64>, <2 x i64>* %resultLo, align 16
  %67 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), <2 x i64> %66)
  %68 = load <2 x i64>, <2 x i64>* %resultHi, align 16
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), <2 x i64> %68)
  %70 = load <2 x i64>, <2 x i64>* %result, align 16
  %71 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0), <2 x i64> %70)
  ret i32 0
}
