...
define i32 @main() #0 {
  ...
  store <2 x i64> %43, <2 x i64>* @c, align 16
  %44 = load <2 x i64>, <2 x i64>* @c, align 16
  %45 = extractelement <2 x i64> %44, i32 1
  %46 = load <2 x i64>, <2 x i64>* @c, align 16
  %47 = extractelement <2 x i64> %46, i32 0
  %48 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i64 %45, i64 %47)
  ret i32 0
}
