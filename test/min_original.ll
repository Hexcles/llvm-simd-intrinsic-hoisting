...
define i32 @main() #0 {
  ...
  %64 = call <8 x i16> @llvm.x86.sse2.pmins.w(<8 x i16> %61, <8 x i16> %63) #3
  %65 = bitcast <8 x i16> %64 to <2 x i64>
  store <2 x i64> %65, <2 x i64>* @c, align 16
  %66 = load <2 x i64>, <2 x i64>* @c, align 16
  %67 = extractelement <2 x i64> %66, i32 1
  %68 = load <2 x i64>, <2 x i64>* @c, align 16
  %69 = extractelement <2 x i64> %68, i32 0
  %70 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i64 %67, i64 %69)
  ret i32 0
}
