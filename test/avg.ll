...
define i32 @main() #0 {
  ...
  %64 = add <8 x i16> %61, %63
  %65 = add <8 x i16> %64, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %66 = lshr <8 x i16> %65, <i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1>
  %67 = bitcast <8 x i16> %66 to <2 x i64>
  store <2 x i64> %67, <2 x i64>* @c, align 16
  %68 = load <2 x i64>, <2 x i64>* @c, align 16
  %69 = extractelement <2 x i64> %68, i32 1
  %70 = load <2 x i64>, <2 x i64>* @c, align 16
  %71 = extractelement <2 x i64> %70, i32 0
  %72 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i64 %69, i64 %71)
  ret i32 0
}
