...
define i32 @main() #0 {
  ...
  %64 = call <2 x i64> @llvm.x86.sse2.psad.bw(<16 x i8> %61, <16 x i8> %63) #3
  store <2 x i64> %64, <2 x i64>* @c, align 16
  %65 = load <2 x i64>, <2 x i64>* @c, align 16
  %66 = extractelement <2 x i64> %65, i32 1
  %67 = load <2 x i64>, <2 x i64>* @c, align 16
  %68 = extractelement <2 x i64> %67, i32 0
  %69 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i64 %66, i64 %68)
  ret i32 0
}
